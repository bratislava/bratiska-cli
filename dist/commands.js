...
exports.kubectl_deployment_status =
  exports.kubect_apply_to_kubernetes =
  exports.kustomize_build_manifest =
  exports.docker_login =
  exports.docker_check_image_in_registry =
  exports.docker_push_image =
  exports.docker_delete_image =
  exports.docker_check_image =
  exports.docker_build =
  exports.docker =
  exports.kubectl_pull_secret =
  exports.kubectl_pods =
  exports.kubectl_cluster =
  exports.git_user =
  exports.git_check_commit_remote =
  exports.git_repo_name =
  exports.git_current_status =
  exports.git_current_commit =
  exports.git_fetch_origin =
  exports.git_repository_url =
  exports.git_current_branch =
  exports.cd =
  exports.pwd =
    void 0;
...
function git_current_branch() {
  const result = child_process_1.default.spawnSync(
    'git',
...
function docker_push_image(options) {
  child_process_1.default.spawnSync(
    'docker',
    ['push', helpers.image_tag(options)],
    {
      stdio: 'inherit',
    },
  );
