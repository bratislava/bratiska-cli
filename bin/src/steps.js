...
const _14_check_ports_numbers_1 = require('./steps/14_check_ports_numbers');
...
class Steps {
  ...
  check_kubernetes_cluster_conditions_5(options) {
    (0,
    _5_check_kubernetes_cluster_conditions_1.check_kubernetes_cluster_conditions)(
      options,
    );
  }
  ...
  check_ports_numbers_14(options) {
    (0, _14_check_ports_numbers_1.check_ports_numbers)(options);
  }
